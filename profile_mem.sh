...
if [ -f "comprehensive_profile.bin" ]; then
    echo "Generating flamegraph"
    memray flamegraph comprehensive_profile.bin -o comprehensive_flame.html
    
    echo "Generating table"
    memray table comprehensive_profile.bin -o comprehensive_table.txt
